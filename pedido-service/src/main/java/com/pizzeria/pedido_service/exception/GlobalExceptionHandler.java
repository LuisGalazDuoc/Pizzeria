package com.pizzeria.pedido_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(
            ...
            HttpServletRequest request) {
        log.warn("Recurso no encontrado en microservicio externo: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleWebClientError(
            ...
            HttpServletRequest request) {
        log.error("Error en comunicación con microservicio externo: {}", ex.getMessage());
